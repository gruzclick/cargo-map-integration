...
8.3.3. **В случае инцидента информационной безопасности** Платформа обязуется:
...
13.3. **Пользователь полностью принимает на себя все риски**, связанные с использованием Платформы.
