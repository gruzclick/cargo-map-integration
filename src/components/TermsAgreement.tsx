              ...
              <div className="space-y-3 text-sm">
                <div>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Информационная платформа "Груз Клик" предназначена для соединения клиентов и перевозчиков 
                    и предоставления информации о доступных услугах. Платформа не является перевозчиком 
